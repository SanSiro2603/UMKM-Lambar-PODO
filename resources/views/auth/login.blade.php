...
<div>
    ...
    <form class="mt-8 space-y-5">
        ...
        <div x-data="{ show: false }">
            ...
            <div class="relative">
                <input id="password" :type="show ? 'text' : 'password'" placeholder="Masukkan password"
    ...
    {{-- Register Links --}}
    <div class="space-y-3">
        <a href="{{ url('/register') }}" class="w-full flex items-center justify-center gap-2 py-3 px-4 border-2 border-surface-300 text-surface-700 font-semibold rounded-xl hover:border-primary-400 hover:text-primary-500 transition-all text-sm">
            Daftar Akun Baru
        </a>
        <a href="{{ url('/register-seller') }}" class="w-full flex items-center justify-center gap-2 py-3 px-4 border-2 border-accent-400 text-accent-600 font-semibold rounded-xl hover:bg-accent-50 transition-all text-sm">
