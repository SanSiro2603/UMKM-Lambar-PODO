    ...
    <section class="bg-white rounded-2xl overflow-hidden shadow-card mb-8">
        ...
        <div class="relative px-5 sm:px-7 lg:px-8 pb-6 sm:pb-7">
            <div class="-mt-12 sm:-mt-14">
                {{-- Logo --}}
                <div class="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-white shadow-card flex items-center justify-center border-4 border-white shrink-0 overflow-hidden mb-4">
                    @if($store->logo)
