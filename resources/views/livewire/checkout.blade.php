        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-card p-5">
                ...
                <div class="p-4 bg-surface-50 border border-surface-200 rounded-xl space-y-3">
                    ...
                    @error('shippingAddress') <span class="text-xs text-red-600 block">{{ $message }}</span> @enderror

                    <div>
                        <label class="block text-xs font-semibold text-surface-500 mb-1">Nomor HP (untuk dihubungi kurir)</label>
                        <input type="text" wire:model="shippingPhone" placeholder="08xxxxxxxxxx" class="w-full px-3 py-2 border border-surface-300 rounded-xl text-sm focus:border-primary-400 focus:ring-1 focus:ring-primary-100">
                        @error('shippingPhone') <span class="text-xs text-red-600 block mt-1">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
